...
export default function Features() {
  return (
    <View Style={{height :hp(60)}} className="space-y-4" >
      ...
      <Text style={{fontSize: 24, fontWeight:"bold",textAlign:"left",marginTop:10}}>
        Features
        </Text>
        ...
        <View className="bg-cyan-200 p-4 rounded-xl space-y-2">
          ...
          <Text style={{fontSize: wp(3.8)}} className="text-gray-700 font-medium">
            A powerful voice assistant with the abilities of ChatGPT and Dall-E, providing you the best pf both worlds.
          </Text>
        </View>
    </View>
  )
